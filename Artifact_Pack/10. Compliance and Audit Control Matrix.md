...
- Where applicable, GDPR-aligned deletion timelines are enforced via automated retention rules in storage backends (see **[8. Observability Data Governance and Retention Policy](8.%20Observability%20Data%20Governance%20and%20Retention%20Policy.md)**, **[9. Observability FinOps Standard](9.%20Observability%20FinOps%20Standard.md)**).
...
## 6. Cross-References
- **[8. Observability Data Governance and Retention Policy](8.%20Observability%20Data%20Governance%20and%20Retention%20Policy.md)** — retention rules audited here.
- **[9. Observability FinOps Standard](9.%20Observability%20FinOps%20Standard.md)** — deletion / compaction mechanics evidenced here.
- **[15. Observability Governance Charter and ARB Pack](15.%20Observability%20Governance%20Charter%20and%20ARB%20Pack.md)** — governance body owning the controls.
- **[16. Observability ADR Decision Register](16.%20Observability%20ADR%20Decision%20Register.md)** — ADRs documenting compliance-driven decisions.
