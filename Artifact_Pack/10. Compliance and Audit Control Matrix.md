...
| OBS-C-10 | Cardinality budget enforced at gateway ([Chapter 1 §3.1](1.%20Enterprise%20Observability%20Standards%20Catalog.md#31-cardinality-governance)) | Internal | Gateway processor config; reject-rate metric | Platform Ops |
...
> Mapping to specific frameworks (SOC2 CC, ISO 27001 Annex A, GDPR Articles) is detailed in §6.

## 6. Framework Mapping

The framework set is selected and governed by [Chapter 15 §4.3](15.%20Observability%20Governance%20Charter%20and%20ARB%20Pack.md#43-framework-selection-and-mapping). This table maps each control above to the specific framework clauses that consume its evidence.
...
**Owner discipline.** Each owner publishes evidence to the central audit-evidence repository indexed by Control ID; the governance body (§7) reviews exceptions and remediation timelines.
...
5. **Report.** Findings logged with severity; remediation tracked to closure in the governance risk register ([Chapter 15 §4.2](15.%20Observability%20Governance%20Charter%20and%20ARB%20Pack.md#42-governance-risk-register)).
...
- **[Chapter 15. Observability Governance Charter and ARB Pack -> Section 4.3. Framework Selection and Mapping](15.%20Observability%20Governance%20Charter%20and%20ARB%20Pack.md#43-framework-selection-and-mapping)** — selects the frameworks mapped in §6.
