...
| `tenant_id` | Auth context (per [Chapter 26](26.%20Multi-Tenant%20and%20Customer-Site%20Deployment%20Model.md)) | `customer-acme` |
...
- PII fields prohibited at source (see [Chapter 23 Section 4. PII Redaction (Concrete Mechanisms)](23.%20Observability%20Platform%20Security%20Architecture.md#4-pii-redaction-concrete-mechanisms)).

## 3.1. Cardinality Governance
Cardinality is the #1 production failure mode for Prometheus and Loki. Enforce three layers:

### 3a.1 Per-Service Cardinality Budget (from [Chapter 22 Section 7](22.%20Capacity%20and%20Scale%20Model.md#7-cardinality-budget))
...
### 3a.3 Enforcement Mechanisms
1. **At source:** SDK-side label allow-list per kit (see [Chapter 25](25.%20Service%20Onboarding%20and%20Instrumentation%20Kits.md)).
...
### 3a.4 Cardinality KPIs
- Per-service cardinality vs budget — dashboard in [Chapter 5](5.%20Grafana%20Platform%20Standard%20and%20Visualization%20Playbook.md).
...
| RTO / RPO | per [Chapter 20](20.%20Business%20Capability%20and%20Value-Stream%20Mapping.md) | per [Chapter 20](20.%20Business%20Capability%20and%20Value-Stream%20Mapping.md) | per [Chapter 20](20.%20Business%20Capability%20and%20Value-Stream%20Mapping.md) | per [Chapter 20](20.%20Business%20Capability%20and%20Value-Stream%20Mapping.md) |

### 4a.3 Tier Assignment
- Tier is assigned at service registration in the catalog.
- Tier changes require ARB approval and an ADR (see [Chapter 16](16.%20Observability%20ADR%20Decision%20Register.md)).
