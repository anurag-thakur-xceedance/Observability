...
| Cardinality drift review ([Chapter 1. Enterprise Observability Standards Catalog -> Section 3.1. Cardinality Governance](1.%20Enterprise%20Observability%20Standards%20Catalog.md#31-cardinality-governance)) | Weekly | Platform Ops | Active-series report |
...
**Retention change.** Data Governance proposes change → Platform Ops models cost and capacity impact ([Chapter 22. Capacity and Scale Model](22.%20Capacity%20and%20Scale%20Model.md)) → governance body approves → Platform Ops applies via IaC ([Chapter 7. IaC for Observability Standard](7.%20IaC%20for%20Observability%20Standard.md)) → post-change validation per [Chapter 7. IaC for Observability Standard -> Section 7.1. Change Management](7.%20IaC%20for%20Observability%20Standard.md#71-change-management).
...
- [Chapter 3. Domain Observability Runbooks Pack](3.%20Domain%20Observability%20Runbooks%20Pack.md) — runbooks for Section 9.1 Day-2 procedures.
- [Chapter 7. IaC for Observability Standard -> Section 7.1. Change Management](7.%20IaC%20for%20Observability%20Standard.md#71-change-management) — change workflow used for Section 9.1 retention changes.
- [Chapter 9. Observability FinOps Standard](9.%20Observability%20FinOps%20Standard.md) — cost-driven lifecycle mechanics.
- [Chapter 10. Compliance and Audit Control Matrix](10.%20Compliance%20and%20Audit%20Control%20Matrix.md) — compliance and audit control matrix; OBS-C-04, OBS-C-08 sourced from Section 9.1.
...
- [Chapter 22. Capacity and Scale Model](22.%20Capacity%20and%20Scale%20Model.md) — capacity inputs to Section 9.1.1 weekly review.
