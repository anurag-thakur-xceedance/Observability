...
- A standard telemetry schema (naming conventions for metrics, labels, log fields, trace attributes) is maintained; see **[1. Enterprise Observability Standards Catalog](1.%20Enterprise%20Observability%20Standards%20Catalog.md)** and **[19. Observability Data Model Specification](19.%20Observability%20Data%20Model%20Specification.md)**.
...
Cost-related lifecycle mechanics (hot / warm / cold storage, downsampling) are owned by **[9. Observability FinOps Standard](9.%20Observability%20FinOps%20Standard.md) — Observability FinOps Standard**. This policy authorises those mechanics; cost optimisation details live in [9. Observability FinOps Standard](9.%20Observability%20FinOps%20Standard.md).
...
(Outcome measurement maintained in **[11. Observability KPI Scorecard](11.%20Observability%20KPI%20Scorecard.md)**.)

## 10. Cross-References
- **[1. Enterprise Observability Standards Catalog](1.%20Enterprise%20Observability%20Standards%20Catalog.md) / [19. Observability Data Model Specification](19.%20Observability%20Data%20Model%20Specification.md)** — telemetry standards and data model the policy enforces.
- **[9. Observability FinOps Standard](9.%20Observability%20FinOps%20Standard.md)** — cost-driven lifecycle mechanics.
- **[10. Compliance and Audit Control Matrix](10.%20Compliance%20and%20Audit%20Control%20Matrix.md)** — compliance and audit control matrix.
- **[11. Observability KPI Scorecard](11.%20Observability%20KPI%20Scorecard.md)** — KPI scorecard for governance success.
- **[15. Observability Governance Charter and ARB Pack](15.%20Observability%20Governance%20Charter%20and%20ARB%20Pack.md)** — governance charter ownership.
