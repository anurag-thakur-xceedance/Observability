...
## 15.4 Architecture Review Board (ARB) Pack
...
| Approve cardinality-budget exception ([Chapter 1. Enterprise Observability Standards Catalog -> Section 1.3.4 Cardinality Governance](01-enterprise-observability-standards-catalog.md#134-cardinality-governance)) | R | C | I | I | I | A | C |
...
| Approve customer-tenant onboarding ([Chapter 26](26-multi-tenant-and-customer-site-deployment-model.md)) | C | R | C | I | C | A | C |
| HA / DR drill execution ([Chapter 21](21-observability-platform-ha-and-dr-design.md)) | I | A,R | I | I | I | I | I |
...
### 15.4.2 Governance Risk Register
...
| GOV-R-02 | Cardinality breach destabilises platform | Med | High | Platform Ops | Budget enforcement at gateway ([Chapter 1. Enterprise Observability Standards Catalog -> Section 1.3.4 Cardinality Governance](01-enterprise-observability-standards-catalog.md#134-cardinality-governance)); reject-on-breach policy | Active series > 90% of budget |
...
| GOV-R-10 | Loss of platform skills / single-point-of-knowledge | Med | High | Platform Ops | CoP rotation ([Chapter 18. Observability Operating Model and Adoption Plan -> Section 18.4.4 Community of Practice](18-observability-operating-model-and-adoption-plan.md#1844-community-of-practice)); runbook coverage ≥ 95% | Bus factor < 2 for any critical component |

### 15.4.3 Framework Selection and Mapping
...
|---|---|---|---|
| **SOC 2 Type II** | Security, Availability, Confidentiality | Primary | Full control mapping; annual audit. See [Chapter 10. Compliance and Audit Control Matrix](10-compliance-and-audit-control-matrix.md) Section 6. |
| **ISO/IEC 27001:2022** | Information security management | Primary | Annex A controls A.5–A.18 mapped to OBS-C-* controls. |
| **GDPR** (EU) | Personal data protection | Primary | Articles 5, 17, 25, 32, 33 mapped; PII redaction enforced ([Chapter 23](23-observability-platform-security-architecture.md)). |
| **NIST CSF 2.0** | Cyber risk framework | Reference | Used to structure risk register (Section 4.2); not audited against. |
...
| **DORA** (EU financial) | Operational resilience | Emerging | Watch-list. ICT third-party risk reporting will require trace continuity ([Chapter 26. Multi-Tenant and Customer-Site Deployment Model -> Section 26.5 Data-Residency](26-multi-tenant-and-customer-site-deployment-model.md#265-data-residency)). |
...
- **Post-Incident:** governance review when major incidents trigger systemic changes (links to [Chapter 12. Incident Response Playbook](12-incident-response-playbook.md) / [Chapter 16. Observability ADR Decision Register](16-observability-adr-decision-register.md)).
- **Regulatory-Driven:** ad-hoc reviews triggered by changes in applicable regulations.

## 15.6 Data Classification & Access Governance
...
- [Chapter 18. Observability Operating Model and Adoption Plan -> Section 18.4.4 Community of Practice](18-observability-operating-model-and-adoption-plan.md#1844-community-of-practice) — CoP that operationalises governance below the ARB.
- [Chapter 25. Service Onboarding and Instrumentation Kits](25-service-onboarding-and-instrumentation-kits.md) — PRR gate enforcing standards approved by Section 3.
