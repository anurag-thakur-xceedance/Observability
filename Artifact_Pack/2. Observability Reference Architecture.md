...
All components are open-source or vendor-neutral; commercial choices (paging, IdP, Vault) are pluggable per [Chapter 23. Observability Platform Security Architecture](23.%20Observability%20Platform%20Security%20Architecture.md).
...
**Decision:** Beyla is recommended as a complementary layer beside the OpenTelemetry SDK kits in [Chapter 25](25.%20Service%20Onboarding%20and%20Instrumentation%20Kits.md) — formalised in **ADR-012** in [Chapter 16](16.%20Observability%20ADR%20Decision%20Register.md).
...
| Logs | Volume control via structured-log policy + level filtering | INFO+ in prod | Fine-grained by service tier (see [Chapter 1 Section 4a](1.%20Enterprise%20Observability%20Standards%20Catalog.md#41-service-tiering-model)) |
...
Detailed control catalogue in [Chapter 23. Observability Platform Security Architecture](23.%20Observability%20Platform%20Security%20Architecture.md).
...
- **`otelcol_processor_dropped_spans`** is a meta-monitor alert (see [Chapter 21 Section 7. Self-Monitoring](21.%20Observability%20Platform%20HA%20and%20DR%20Design.md#7-self-monitoring-meta-monitor)).

### 7.5 Schema Validation and Cardinality Controls
- Cardinality enforcement per [Chapter 1 Section 3a](1.%20Enterprise%20Observability%20Standards%20Catalog.md#31-cardinality-governance).
...
- [Chapter 21. Observability Platform HA and DR Design](21.%20Observability%20Platform%20HA%20and%20DR%20Design.md) — HA topology overlaid on this architecture.
- [Chapter 22. Capacity and Scale Model](22.%20Capacity%20and%20Scale%20Model.md) — sizing and scale-out triggers.
- [Chapter 23. Observability Platform Security Architecture](23.%20Observability%20Platform%20Security%20Architecture.md) — auth, encryption, redaction, supply-chain.
- [Chapter 26. Multi-Tenant and Customer-Site Deployment Model](26.%20Multi-Tenant%20and%20Customer-Site%20Deployment%20Model.md) — multi-tenant and customer-site topologies.
