...
The entire backend (Collector, Prometheus, Loki, Tempo, Grafana, exporters) is defined as a **Docker Compose** project and provisioned / managed by **PowerShell** scripts. See **[7. IaC for Observability Standard](7.%20IaC%20for%20Observability%20Standard.md)** for the IaC standard.
...
2. **Application.** Pre-login (auth/MFA/API gateway) and post-login (transactions, dependencies, journeys). OpenTelemetry SDK in each service exports OTLP to the Collector. See **[17. Application Telemetry Standard](17.%20Application%20Telemetry%20Standard.md)** for application telemetry standards.
...
A fifth, emerging layer — **Profiles** (Pyroscope-style stack-trace profiling) — is treated as a near-term extension. See **[1. Enterprise Observability Standards Catalog](1.%20Enterprise%20Observability%20Standards%20Catalog.md)** for the formal pillar definition.
...
**Design constraints (see [7. IaC for Observability Standard](7.%20IaC%20for%20Observability%20Standard.md) for KPIs):**
...
## 8. Cross-References
- **[1. Enterprise Observability Standards Catalog](1.%20Enterprise%20Observability%20Standards%20Catalog.md)** — telemetry standards consumed by this architecture.
- **[5. Grafana Platform Standard and Visualization Playbook](5.%20Grafana%20Platform%20Standard%20and%20Visualization%20Playbook.md)** — Grafana platform standards and dashboard playbook.
...
- **[8. Observability Data Governance and Retention Policy](8.%20Observability%20Data%20Governance%20and%20Retention%20Policy.md)** — data lifecycle and retention applied to backends.
- **[19. Observability Data Model Specification](19.%20Observability%20Data%20Model%20Specification.md)** — formal data model for entities/relationships across pillars.
