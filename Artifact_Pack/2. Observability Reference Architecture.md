...
The entire backend (Collector, Prometheus, Loki, Tempo, Grafana, exporters) is defined as a **Docker Compose** project and provisioned / managed by **PowerShell** scripts. See **[Chapter 7. IaC for Observability Standard](7.%20IaC%20for%20Observability%20Standard.md)** for the IaC standard.
...
A fifth, emerging layer — **Profiles** (Pyroscope-style stack-trace profiling) — is treated as a near-term extension. See **[Chapter 1. Enterprise Observability Standards Catalog](1.%20Enterprise%20Observability%20Standards%20Catalog.md)** for the formal pillar definition.
