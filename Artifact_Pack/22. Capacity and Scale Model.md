...
### 2.2 Medium (3-host HA Compose, per [Chapter 21](21.%20Observability%20Platform%20HA%20and%20DR%20Design.md))
...
(Numbers are illustrative; actual figures must be modelled in [Chapter 9. Observability FinOps Standard](9.%20Observability%20FinOps%20Standard.md).)
...
Enforcement is described in [Chapter 1 Section 3.1. Cardinality Governance](1.%20Enterprise%20Observability%20Standards%20Catalog.md#31-cardinality-governance).

## 8. Cross-References
- [Chapter 2. Observability Reference Architecture](2.%20Observability%20Reference%20Architecture.md)
- [Chapter 7. IaC for Observability Standard](7.%20IaC%20for%20Observability%20Standard.md) — Compose configurations sized to these reference deployments.
- [Chapter 9. Observability FinOps Standard](9.%20Observability%20FinOps%20Standard.md) — cost modelling and unit economics.
- [Chapter 21. Observability Platform HA and DR Design](21.%20Observability%20Platform%20HA%20and%20DR%20Design.md) — HA topology overlaid on these sizes.
