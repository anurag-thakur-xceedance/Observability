...
## 1. Purpose
Lifecycle policies manage cost and performance of observability platforms. This standard defines the cost-management mechanics that operationalise the retention authorisations in **[Chapter 8. Observability Data Governance and Retention Policy](8.%20Observability%20Data%20Governance%20and%20Retention%20Policy.md)**.
...
### 6a.2 Unit Cost Definitions

| Unit | Definition | Reporting Cadence | Used By |
|---|---|---|---|
| **$/active series/month** | Prometheus active series cost ÷ active series count | Monthly | Cardinality reviews ([Chapter 1 §3.1](1.%20Enterprise%20Observability%20Standards%20Catalog.md#31-cardinality-governance)) |
...
| **$/tenant/month** | Per-tenant attributed cost | Monthly | Multi-tenant chargeback ([Chapter 26](26.%20Multi-Tenant%20and%20Customer-Site%20Deployment%20Model.md)) |
| **$/engineer/month** | Total cost ÷ engineers using the platform | Monthly | Platform productivity metric |

### 6a.3 Indicative Unit-Cost Benchmarks
...
- **Logs:** `service` is a required Loki stream label per [Chapter 1](1.%20Enterprise%20Observability%20Standards%20Catalog.md).
...
The attribution model is the basis for **chargeback / showback** in §6.2.

### 6a.5 Showback vs. Chargeback Decision
...
The decision to move from showback to chargeback is an ARB decision recorded in [Chapter 16](16.%20Observability%20ADR%20Decision%20Register.md).
...
### 6b.1 The Top-5 Levers (in order of impact)
...
### 6b.2 Optimisation Cycle

```
Monthly review:
  1. Compute unit costs (§6.1.2)
  ...
  5. Apply lever (§6.2.1) appropriate to the signal
  6. Measure unit cost in next cycle; rollback if no improvement
```

### 6b.3 Optimisation Anti-Patterns
...
- **Optimising during incident.** Freeze optimisation activity during active incidents and during the change-freeze windows in [Chapter 7 §7.1.4](7.%20IaC%20for%20Observability%20Standard.md#71-change-management).
- **One-off "spring cleaning"**. Optimisation must be cyclical (§6.2.2) — single events drift back within a quarter.

## 6.3. Forecast and Budget Model

Inputs and outputs of the FinOps planning cycle.

### 6c.1 Forecast Inputs

| Input | Source | Update Cadence |
|---|---|---|
| Service onboarding pipeline | [Chapter 25](25.%20Service%20Onboarding%20and%20Instrumentation%20Kits.md) | Monthly |
| Service tier distribution | [Chapter 1 §4.1](1.%20Enterprise%20Observability%20Standards%20Catalog.md#41-service-tiering-model) | Quarterly |
| Cardinality budget headroom | [Chapter 1 §3.1](1.%20Enterprise%20Observability%20Standards%20Catalog.md#31-cardinality-governance) | Monthly |
| Capacity sizing model | [Chapter 22](22.%20Capacity%20and%20Scale%20Model.md) | Quarterly |
| Tenant onboarding pipeline | [Chapter 26](26.%20Multi-Tenant%20and%20Customer-Site%20Deployment%20Model.md) | Monthly |
| Vendor unit-rate changes | Contracts | As-changed |

### 6c.2 Budget Envelope
...
| Negative variance > 10% | Investigate under-instrumentation (false economy); review against telemetry quality SLIs ([Chapter 11 §6.1](11.%20Observability%20KPI%20Scorecard.md#61-telemetry-data-quality-slis)) |

## 7. Deletion & Compaction Monitoring
Retention rules are configured in storage backends (Prometheus, Loki, Tempo, object storage). Deletion and compaction jobs are monitored to enforce policy and regulations (e.g. GDPR-aligned deletion timelines). See **[Chapter 8. Observability Data Governance and Retention Policy -> Section 7. Deletion and Retention Enforcement](8.%20Observability%20Data%20Governance%20and%20Retention%20Policy.md#7-deletion-and-retention-enforcement)**, **[Chapter 10. Compliance and Audit Control Matrix](10.%20Compliance%20and%20Audit%20Control%20Matrix.md)**.

## 8. Cross-References
- **[Chapter 1. Enterprise Observability Standards Catalog](1.%20Enterprise%20Observability%20Standards%20Catalog.md)** — cardinality budgets and tier model that drive cost (§6.1, §6.2).
...
- **[Chapter 11. Observability KPI Scorecard -> Section 6.1. Telemetry Data Quality SLIs](11.%20Observability%20KPI%20Scorecard.md#61-telemetry-data-quality-slis)** — quality SLIs that bound cost cuts.
- **[Chapter 15. Observability Governance Charter and ARB Pack](15.%20Observability%20Governance%20Charter%20and%20ARB%20Pack.md)** — governance approval for tiering and chargeback changes.
- **[Chapter 22. Capacity and Scale Model](22.%20Capacity%20and%20Scale%20Model.md)** — capacity inputs to §6.3 forecast.
- **[Chapter 25. Service Onboarding and Instrumentation Kits](25.%20Service%20Onboarding%20and%20Instrumentation%20Kits.md)** — onboarding pipeline feeding §6.3 forecast.
- **[Chapter 26. Multi-Tenant and Customer-Site Deployment Model](26.%20Multi-Tenant%20and%20Customer-Site%20Deployment%20Model.md)** — per-tenant cost attribution (§6.1.4, §6.1.5).
