...
## 17.3 Pre-Login Telemetry (Required Fields & Standards)
...
### 17.3.1 Required Trace Attributes (Pre-Login)
...
## 17.4 Post-Login Telemetry (Required Fields & Standards)
...
### 17.4.1 Required Trace Attributes (Post-Login)
...
### 17.4.2 Required Span Hierarchy
...
## 17.6 PII & Data Classification
- **PII prohibited** in logs and traces wherever possible.
- Masking / tokenisation / redaction enforced at source or in the OpenTelemetry pipeline (see [Chapter 8. Observability Data Governance and Retention Policy -> Section 8.5 Data Classification](08-observability-data-governance-and-retention-policy.md#85-data-classification)).

## 17.7 Conformance
- Services must meet this standard before production promotion (see [Chapter 8. Observability Data Governance and Retention Policy -> Section 8.6 Data Quality and Standards](08-observability-data-governance-and-retention-policy.md#86-data-quality-and-standards)).
...
- [Chapter 3. Domain Observability Runbooks Pack -> Section 3.3 Application Observability Runbook (Pre-Login & Post-Login Execution Steps)](03-domain-observability-runbooks-pack.md#33-application-observability-runbook-pre-login-post-login-execution-steps) — operational runbook applying this telemetry.
