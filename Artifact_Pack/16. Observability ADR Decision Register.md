...
| ADR-004 | Adopt PowerShell + Docker Compose for IaC and orchestration (supersedes earlier Pulumi/Kubernetes direction) | Accepted (revised) | [7. IaC for Observability Standard](7.%20IaC%20for%20Observability%20Standard.md); Strategy §"IaC Role in OpenTelemetry Deployment" |
| ADR-005 | Host-portable deployment (on-prem / customer site / cloud VM) via the same Compose stack — supersedes earlier multi-cloud K8s posture | Accepted (revised) | [2. Observability Reference Architecture § 6. Host-Portable Deployment Design](2.%20Observability%20Reference%20Architecture.md#6-host-portable-deployment-design); [7. IaC for Observability Standard](7.%20IaC%20for%20Observability%20Standard.md) |
...
## 4. Cross-References
- **[2. Observability Reference Architecture](2.%20Observability%20Reference%20Architecture.md) / [5. Grafana Platform Standard and Visualization Playbook](5.%20Grafana%20Platform%20Standard%20and%20Visualization%20Playbook.md) / [7. IaC for Observability Standard](7.%20IaC%20for%20Observability%20Standard.md)** — architectural decisions implemented.
- **[15. Observability Governance Charter and ARB Pack](15.%20Observability%20Governance%20Charter%20and%20ARB%20Pack.md)** — governance body that ratifies ADRs.
