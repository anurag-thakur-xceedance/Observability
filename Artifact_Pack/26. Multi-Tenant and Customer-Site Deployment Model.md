...
1. **SDK / kit defaults** ([Chapter 25](25.%20Service%20Onboarding%20and%20Instrumentation%20Kits.md)) inject required attributes from environment.
...
- Egress allow-list ([Chapter 23 Section 8. Egress and Data-Residency Controls](23.%20Observability%20Platform%20Security%20Architecture.md#8-egress-and-data-residency-controls)) blocks unauthorised cross-border transfer.
...
DR runbook per customer site is templated and parameterised in [Chapter 7. IaC for Observability Standard](7.%20IaC%20for%20Observability%20Standard.md).
...
| First service onboarded per [Chapter 25](25.%20Service%20Onboarding%20and%20Instrumentation%20Kits.md) | Service Owner |
| Tenant-scoped dashboard reviewed with customer | Customer Operations + Customer |

## 10. Cross-References
- [Chapter 2. Observability Reference Architecture](2.%20Observability%20Reference%20Architecture.md) — base topology.
- [Chapter 17. Application Telemetry Standard](17.%20Application%20Telemetry%20Standard.md) — required tenant attributes on telemetry.
- [Chapter 19. Observability Data Model Specification](19.%20Observability%20Data%20Model%20Specification.md) — `tenant_class`, `tenant_id` namespace.
- [Chapter 21. Observability Platform HA and DR Design](21.%20Observability%20Platform%20HA%20and%20DR%20Design.md) — DR patterns, including customer-site DR.
- [Chapter 23. Observability Platform Security Architecture](23.%20Observability%20Platform%20Security%20Architecture.md) — auth, encryption, egress controls.
- [Chapter 25. Service Onboarding and Instrumentation Kits](25.%20Service%20Onboarding%20and%20Instrumentation%20Kits.md) — kit injection of tenant attributes.
