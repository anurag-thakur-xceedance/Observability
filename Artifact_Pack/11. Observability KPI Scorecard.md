...
## 5. Platform KPIs Roll-Up (from [7. IaC for Observability Standard](7.%20IaC%20for%20Observability%20Standard.md) — Docker Compose + PowerShell)
...
## 6. Maturity Phase Targets (from [14. Observability Capability Assessment Framework](14.%20Observability%20Capability%20Assessment%20Framework.md) / Roadmap)
...
## 7. Reporting Cadence
- KPI scorecard reviewed **monthly** at the observability governance body (see **[15. Observability Governance Charter and ARB Pack](15.%20Observability%20Governance%20Charter%20and%20ARB%20Pack.md)**).
- Phase-target progress reviewed at **quarterly** ARB.
- Incident-driven adjustments raised through **[16. Observability ADR Decision Register](16.%20Observability%20ADR%20Decision%20Register.md)** (ADRs).

## 8. Cross-References
- **[7. IaC for Observability Standard](7.%20IaC%20for%20Observability%20Standard.md)** — IaC platform KPIs roll-up.
- **[8. Observability Data Governance and Retention Policy](8.%20Observability%20Data%20Governance%20and%20Retention%20Policy.md) / [9. Observability FinOps Standard](9.%20Observability%20FinOps%20Standard.md) / [10. Compliance and Audit Control Matrix](10.%20Compliance%20and%20Audit%20Control%20Matrix.md)** — governance, FinOps, compliance KPIs feeding here.
- **[13. Observability Roadmap Delivery Plan](13.%20Observability%20Roadmap%20Delivery%20Plan.md)** — roadmap phase plan that drives phase targets.
- **[14. Observability Capability Assessment Framework](14.%20Observability%20Capability%20Assessment%20Framework.md)** — capability assessment framework feeding maturity scoring.
