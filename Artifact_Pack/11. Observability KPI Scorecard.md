...
The observability platform is itself a tier-1 service whose **inputs** (the telemetry from instrumented services) and **outputs** (the data available to query) must meet quality SLIs. Without these SLIs, every other KPI in this scorecard is built on sand. Sourced from [Chapter 1 §3.1](1.%20Enterprise%20Observability%20Standards%20Catalog.md#31-cardinality-governance), [Chapter 8 §6](8.%20Observability%20Data%20Governance%20and%20Retention%20Policy.md), and [Chapter 21 §7](21.%20Observability%20Platform%20HA%20and%20DR%20Design.md#7-self-monitoring-meta-monitor).

### 6a.1 Ingest Quality SLIs
...
### 6a.5 Error Budget for Telemetry Quality

The platform itself runs SLOs against §6.1.1–6a.4 SLIs, with a **30-day error budget**, modelled per [Chapter 24](24.%20SLO%20and%20Error-Budget%20Framework.md). When the platform's own error budget burns:
- **50% burn**: Platform Ops freezes all Normal-class changes ([Chapter 7 §7.1.4](7.%20IaC%20for%20Observability%20Standard.md#71-change-management)).
...
§6.1 SLIs appear on the **Platform Health** dashboard, viewable to all engineers, and on the executive scorecard with a single "Telemetry Quality" composite (worst-of approach: the composite shows the worst-performing SLI category to avoid masking issues by averaging).

## 7. Reporting Cadence
- KPI scorecard reviewed **monthly** at the observability governance body (see **[Chapter 15. Observability Governance Charter and ARB Pack](15.%20Observability%20Governance%20Charter%20and%20ARB%20Pack.md)**).
- Phase-target progress reviewed at **quarterly** ARB.
- Incident-driven adjustments raised through **[Chapter 16. Observability ADR Decision Register](16.%20Observability%20ADR%20Decision%20Register.md)** (ADRs).

## 8. Cross-References
- **[Chapter 1. Enterprise Observability Standards Catalog -> Section 3.1. Cardinality Governance](1.%20Enterprise%20Observability%20Standards%20Catalog.md#31-cardinality-governance)** — feeds §6.1.2 cardinality SLI.
- **[Chapter 7. IaC for Observability Standard](7.%20IaC%20for%20Observability%20Standard.md)** — IaC platform KPIs roll-up.
- **[Chapter 8. Observability Data Governance and Retention Policy](8.%20Observability%20Data%20Governance%20and%20Retention%20Policy.md) / [Chapter 9. Observability FinOps Standard](9.%20Observability%20FinOps%20Standard.md) / [Chapter 10. Compliance and Audit Control Matrix](10.%20Compliance%20and%20Audit%20Control%20Matrix.md)** — governance, FinOps, compliance KPIs feeding here.
- **[Chapter 13. Observability Roadmap Delivery Plan](13.%20Observability%20Roadmap%20Delivery%20Plan.md)** — roadmap phase plan that drives phase targets.
- **[Chapter 14. Observability Capability Assessment Framework](14.%20Observability%20Capability%20Assessment%20Framework.md)** — capability assessment framework feeding maturity scoring.
- **[Chapter 18. Observability Operating Model and Adoption Plan -> Section 7.1. Adoption KPIs](18.%20Observability%20Operating%20Model%20and%20Adoption%20Plan.md#71-adoption-kpis)** — adoption KPIs sourced into this scorecard.
- **[Chapter 21. Observability Platform HA and DR Design](21.%20Observability%20Platform%20HA%20and%20DR%20Design.md)** — self-monitoring drives §6.1 measurements.
- **[Chapter 24. SLO and Error-Budget Framework](24.%20SLO%20and%20Error-Budget%20Framework.md)** — framework for §6.1.5 platform error budget.
