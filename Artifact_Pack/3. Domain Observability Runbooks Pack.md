...
## 1. Purpose
This pack contains operational runbooks that translate the standards in **[1. Enterprise Observability Standards Catalog](1.%20Enterprise%20Observability%20Standards%20Catalog.md)** into day-to-day actions. Each runbook covers: signals to watch, what they mean, immediate diagnostics, and remediation steps. Severities and escalation are governed by **[4. Alerting and Incident Severity Policy](4.%20Alerting%20and%20Incident%20Severity%20Policy.md)**. The deployment platform is described in **[7. IaC for Observability Standard](7.%20IaC%20for%20Observability%20Standard.md)** (Docker Compose + PowerShell).
...
### 2.1 Signals
CPU, memory, disk I/O, container restarts, host failures, Compose service restarts, container start time. Metric thresholds: see **[1. Enterprise Observability Standards Catalog § 4. Infrastructure Telemetry Standards](1.%20Enterprise%20Observability%20Standards%20Catalog.md#4-infrastructure-telemetry-standards)**.
...
> Standards and field definitions live in **[17. Application Telemetry Standard](17.%20Application%20Telemetry%20Standard.md)**. This runbook covers operational execution.
...
### 4.1 Signals
Slow queries, lock contention, connection-pool usage, replication lag, query latency. Thresholds: **[1. Enterprise Observability Standards Catalog § 7. Database Telemetry Standards](1.%20Enterprise%20Observability%20Standards%20Catalog.md#7-database-telemetry-standards)**.
...
### 5.1 Signals
Packet drops, cross-service latency, DNS failures, inter-service errors, TCP retransmissions. Thresholds: **[1. Enterprise Observability Standards Catalog § 8. Network & Latency Telemetry Standards](1.%20Enterprise%20Observability%20Standards%20Catalog.md#8-network-latency-telemetry-standards)**.
...
### 6.1 Signals
Queue length, request latency, error rate, container startup time, cold-start latency. Thresholds: **[1. Enterprise Observability Standards Catalog § 9. Scaling & Performance Telemetry Standards](1.%20Enterprise%20Observability%20Standards%20Catalog.md#9-scaling-performance-telemetry-standards)**.
...
## 8. Cross-References
- **[1. Enterprise Observability Standards Catalog](1.%20Enterprise%20Observability%20Standards%20Catalog.md)** — metric definitions and threshold catalog.
- **[4. Alerting and Incident Severity Policy](4.%20Alerting%20and%20Incident%20Severity%20Policy.md)** — severity policy and alert routing.
- **[5. Grafana Platform Standard and Visualization Playbook](5.%20Grafana%20Platform%20Standard%20and%20Visualization%20Playbook.md)** — Grafana dashboard structure.
- **[7. IaC for Observability Standard](7.%20IaC%20for%20Observability%20Standard.md)** — Docker Compose + PowerShell deployment standard.
- **[12. Incident Response Playbook](12.%20Incident%20Response%20Playbook.md)** — incident response playbook for end-to-end resolution.
