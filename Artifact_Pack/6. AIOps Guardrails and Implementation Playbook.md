...
- [Chapter 10. Compliance and Audit Control Matrix -> Section 5. Control Matrix (Initial)](10.%20Compliance%20and%20Audit%20Control%20Matrix.md#5-control-matrix-initial) — OBS-C-14 audits the lifecycle in Section 7.
- [Chapter 11. Observability KPI Scorecard](11.%20Observability%20KPI%20Scorecard.md) — Phase 3 KPI targets (MTTD < 1 min, automated tickets > 90%); AI safety KPIs from Section 8.5.
