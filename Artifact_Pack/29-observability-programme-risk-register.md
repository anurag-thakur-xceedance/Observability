...
# 29. Observability Programme Risk Register
...
Out-of-scope: operational incident risk (handled in [Chapter 13. Observability Incident Response Playbook](04-alerting-and-incident-severity-policy.md)), and per-service application risks (owned by service teams, not the platform).
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| R-01 | Cardinality explosion in metrics tier exceeds capacity model and drives unplanned cost or platform instability. | FinOps / Capacity | 4 | 4 | 16 | Platform Lead | Cardinality governance per [Chapter 3. Observability Strategy and Architecture Overview -> Section 3.1 Cardinality Governance](03-domain-observability-runbooks-pack.md); capacity model in [Chapter 22. Capacity and Scale Model](22-capacity-and-scale-model.md); FinOps guardrails in [Chapter 9. Observability FinOps Standard](09-observability-finops-standard.md). | 2 | 3 | 6 | Ch 3, Ch 9, Ch 22 |
...
- [Chapter 2. Observability Programme Charter and Outcomes](13-observability-roadmap-delivery-plan.md) — programme objectives and value tree referenced by R-14.
...
- [Chapter 8. Observability Data Governance and Retention Policy](08-observability-data-governance-and-retention-policy.md) — retention and erasure mitigations for R-03.
- [Chapter 9. Observability FinOps Standard](09-observability-finops-standard.md) — cost mitigations for R-01 and R-07.
- [Chapter 10. Compliance and Audit Control Matrix](10-compliance-and-audit-control-matrix.md) — control mappings and evidence catalogue feeding R-04, R-10, and R-12.
- [Chapter 13. Observability Incident Response Playbook](04-alerting-and-incident-severity-policy.md) — operational incident handling distinct from this register.
- [Chapter 15. Observability Governance Charter and ARB Pack](15-observability-governance-charter-and-arb-pack.md) — ARB ownership of this register.
- [Chapter 17. Application Telemetry Standard](17-application-telemetry-standard.md) — PII handling for R-03.
- [Chapter 19. Observability Data Model Specification](19-observability-data-model-specification.md) — schema controls for R-13.
- [Chapter 21. Observability Platform HA and DR Design](21-observability-platform-ha-and-dr-design.md) — DR controls for R-05.
- [Chapter 22. Capacity and Scale Model](22-capacity-and-scale-model.md) — capacity controls for R-01.
- [Chapter 23. Observability Platform Security Architecture](23-observability-platform-security-architecture.md) — security controls for R-12.
- [Chapter 25. Observability Operating Model and Team Topology](18-observability-operating-model-and-adoption-plan.md) — skills and staffing controls for R-08.
- [Chapter 27. Observability Non-Functional Requirements Register](27-observability-non-functional-requirements.md) — NFRs that underpin several rows.
- [Chapter 28. Observability Long-Term Archival Policy](28-observability-long-term-archival-policy.md) — integrity, restore, and erasure controls for R-03, R-04, R-07, and R-12.
