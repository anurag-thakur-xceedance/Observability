...
### C1 — Instrumented Service (SDK / Agent)
...
### C3 / C4 / C5 — Backends (Prometheus, Loki, Tempo)

| Threat | Description | Primary Mitigation | Reference | Residual |
|---|---|---|---|---|
| **S** | Unauthorised write to backend | Backend accepts only collector identity (mTLS) | NFR-SEC-01 | L |
| **T** | Stored telemetry altered post-write | Object-storage WORM where used; integrity sampling | [Chapter 28 -> Section 5.3. Integrity & Tamper Evidence](28-observability-long-term-archival-policy.md#53-integrity-tamper-evidence) | L |
...
### C6 — Grafana (Visualization & Alerting)
...
### C7 — AIOps Layer (Anomaly / RCA / LLM)
...
| **T** | Archive object altered post-write | WORM / object-lock; signed sidecar; integrity sweeps | [Chapter 28 -> Section 5.3. Integrity & Tamper Evidence](28-observability-long-term-archival-policy.md#53-integrity-tamper-evidence) | L |
| **R** | Restore action denied by actor | Restore ticketing + RACI approval + audit | [Chapter 28 -> Section 6.2. Restore From Archive](28-observability-long-term-archival-policy.md#62-restore-from-archive) | L |
| **I** | Archive object exfiltrated | At-rest encryption with CMK; egress alerts | [Chapter 28 -> Section 5.4. Encryption](28-observability-long-term-archival-policy.md#54-encryption) | M |
| **D** | Restore-storm exhausts retrieval quota | Per-tenant restore quotas; tiered retrieval | [Chapter 28 -> Section 12. Cost Model](28-observability-long-term-archival-policy.md#12-cost-model) | L |
| **E** | Erasure abused to destroy evidence | Legal-hold gate blocks erasure; DPO approval required | [Chapter 28 -> Section 9. Legal Hold](28-observability-long-term-archival-policy.md#9-legal-hold) | L |
