...
| Service Tier (per [Chapter 1. Enterprise Observability Standards Catalog -> Section 4.1. Service Tiering Model](1.%20Enterprise%20Observability%20Standards%20Catalog.md#41-service-tiering-model)) | Availability SLO | Latency SLO | Window |
|---|---|---|---|
...
Exception process: written waiver from Director SRE + Service Owner with stated remediation timeline; logged in [Chapter 16. Observability ADR Decision Register](16.%20Observability%20ADR%20Decision%20Register.md).
...
6. Burn-rate alerts deployed via Git-managed Prometheus rules (see [Chapter 7](7.%20IaC%20for%20Observability%20Standard.md)).
7. Quarterly review.
...
This rolls up to the alerting KPIs in [Chapter 11. Observability KPI Scorecard](11.%20Observability%20KPI%20Scorecard.md).

## 10. Cross-References
- [Chapter 4. Alerting and Incident Severity Policy](4.%20Alerting%20and%20Incident%20Severity%20Policy.md) — severity model that burn-rate alerts plug into.
- [Chapter 11. Observability KPI Scorecard](11.%20Observability%20KPI%20Scorecard.md) — outcome KPIs derived from SLO posture.
- [Chapter 12. Incident Response Playbook](12.%20Incident%20Response%20Playbook.md) — what happens when a burn alert fires.
- [Chapter 17. Application Telemetry Standard](17.%20Application%20Telemetry%20Standard.md) — required SLI labels in app telemetry.
- [Chapter 20. Business Capability and Value-Stream Mapping](20.%20Business%20Capability%20and%20Value-Stream%20Mapping.md) — outcome → SLO traceability.
