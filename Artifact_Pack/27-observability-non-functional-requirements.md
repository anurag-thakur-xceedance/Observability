...
| NFR-CAP-01 | PromQL: `sum by (service) (prometheus_tsdb_head_series{service!=""}) > on() group_left service_tier_max_series` | Per-service cardinality report (weekly export from KPI dashboard) | Weekly job exports series-by-service; breaches generate Jira tickets to the owning service team per [Chapter 1, Section 3.1 — Cardinality Governance](01-enterprise-observability-standards-catalog.md#31-cardinality-governance) | Platform Engineering | Weekly | Zero unresolved breaches > 14 days |
