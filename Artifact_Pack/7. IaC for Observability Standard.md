...
Changes to the observability platform are themselves a **change-managed** activity, distinct from changes by service teams to their service-level dashboards/alerts (covered by [Chapter 5 §7.1](5.%20Grafana%20Platform%20Standard%20and%20Visualization%20Playbook.md#71-dashboards-as-code)).
...
| **Major** | Backend replacement (e.g. swap Prometheus for VictoriaMetrics); cross-cloud migration; new T1 tenant | ARB-ratified ADR ([Chapter 16](16.%20Observability%20ADR%20Decision%20Register.md)) | Approved release train | Full DR-style rollback rehearsed |
...
[Idea] → [Design / RFC if Normal+] → [PR opened]
                                        ...
                                        └─ Progressive rollout (waves of 25% / 50% / 100%)
                                              └─ Each wave gated on platform KPIs (§4)
```
...
- No critical-severity self-monitoring alert ([Chapter 21 §7](21.%20Observability%20Platform%20HA%20and%20DR%20Design.md#7-self-monitoring-meta-monitor)).
- Cardinality budget ([Chapter 1 §3.1](1.%20Enterprise%20Observability%20Standards%20Catalog.md#31-cardinality-governance)) within ±5% of pre-change baseline.

### 7a.3 Rollback Standards
...
### 7a.4 Change Calendar and Freezes
...
The post-change report is the auditable evidence under **OBS-C-02** ([Chapter 10](10.%20Compliance%20and%20Audit%20Control%20Matrix.md)).
...
- **[Chapter 5. Grafana Platform Standard and Visualization Playbook -> Section 7.1. Dashboards-as-Code](5.%20Grafana%20Platform%20Standard%20and%20Visualization%20Playbook.md#71-dashboards-as-code)** — service-level dashboards-as-code workflow conforming to this standard.
- **[Chapter 10. Compliance and Audit Control Matrix](10.%20Compliance%20and%20Audit%20Control%20Matrix.md)** — OBS-C-02 audits change records produced by §7.1.
...
- **[Chapter 21. Observability Platform HA and DR Design](21.%20Observability%20Platform%20HA%20and%20DR%20Design.md)** — self-monitoring signals gating §7.1 wave promotion.
