...
Owned by **[4. Alerting and Incident Severity Policy § 4. Domain-Specific Triggers (Reference)](4.%20Alerting%20and%20Incident%20Severity%20Policy.md#4-domain-specific-triggers-reference).7**. Summary:
...
**In Grafana (see also [5. Grafana Platform Standard and Visualization Playbook](5.%20Grafana%20Platform%20Standard%20and%20Visualization%20Playbook.md)):**
...
## 8. Cross-References
- **[2. Observability Reference Architecture](2.%20Observability%20Reference%20Architecture.md)** — reference architecture deployed by these scripts.
- **[4. Alerting and Incident Severity Policy](4.%20Alerting%20and%20Incident%20Severity%20Policy.md)** — deployment severity policy entry.
- **[11. Observability KPI Scorecard](11.%20Observability%20KPI%20Scorecard.md)** — platform KPI roll-up to executive scorecard.
- **[15. Observability Governance Charter and ARB Pack](15.%20Observability%20Governance%20Charter%20and%20ARB%20Pack.md)** — change control / ARB approvals for stack changes.
- **[16. Observability ADR Decision Register](16.%20Observability%20ADR%20Decision%20Register.md)** — ADR for choice of Docker Compose + PowerShell.
