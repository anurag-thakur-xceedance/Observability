...
- No critical-severity self-monitoring alert ([Chapter 21. Observability Platform HA and DR Design -> Section 7. Self-Monitoring (Meta-Monitor)](21.%20Observability%20Platform%20HA%20and%20DR%20Design.md#7-self-monitoring-meta-monitor)).
- Cardinality budget ([Chapter 1. Enterprise Observability Standards Catalog -> Section 3.1. Cardinality Governance](1.%20Enterprise%20Observability%20Standards%20Catalog.md#31-cardinality-governance)) within ±5% of pre-change baseline.
...
- [Chapter 10. Compliance and Audit Control Matrix](10.%20Compliance%20and%20Audit%20Control%20Matrix.md) — OBS-C-02 audits change records produced by Section 7.1.
...
- [Chapter 21. Observability Platform HA and DR Design](21.%20Observability%20Platform%20HA%20and%20DR%20Design.md) — self-monitoring signals gating Section 7.1 wave promotion.
