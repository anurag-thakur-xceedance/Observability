...
| 3 | Standardise Telemetry Data — The 5 Pillars | EXTRACT | 1 | Pillar definitions in artifact 1 §2. |
...
| 8 | Core Open-Source Observability Stack | EXTRACT | 2 | Stack table in artifact 2 §4. |
| 9 | Telemetry Collection Layers | EXTRACT | 2 | Collection layer model in artifact 2 §5. |
| 10 | Infrastructure Observability | EXTRACT | 3 | Runbook in artifact 3 §2. |
| 11 | Application Telemetry (Pre/Post-Login) | MIXED | 17 | High-level requirement summary kept; standards → artifact 17. |
| 12 | Pre-Login Telemetry | EXTRACT | 17, 3 | Standards → artifact 17 §3; runbook → artifact 3 §3.1. |
| 13 | Post-Login Telemetry | EXTRACT | 17, 3 | Standards → artifact 17 §4; runbook → artifact 3 §3.2. |
| 14 | Alerting Guidelines | EXTRACT | 4 | Policy in artifact 4. |
| 15 | Database Observability | EXTRACT | 3 | Runbook in artifact 3 §4. |
| 16 | Database Observability Metrics and Ranges | EXTRACT | 1, 3 | Standards in artifact 1 §7; runbook usage in artifact 3 §4. |
| 17 | Suggested Alerting Policy Guidelines | EXTRACT | 4 | Consolidated in artifact 4. |
| 18 | Network and Latency Observability | EXTRACT | 3 | Runbook in artifact 3 §5. |
| 19 | Network & Latency Observability Metrics | EXTRACT | 1, 3 | Standards in artifact 1 §8; runbook in artifact 3 §5. |
| 20 | Severity Policy (Network) | EXTRACT | 4 | Artifact 4 §4.3. |
| 21 | Implementation Tips (Network) | EXTRACT | 3 | Artifact 3 §5.3. |
| 22 | Scaling and Performance Observability | MIXED | 3 | Posture kept; implementation → artifact 3 §6. |
| 23 | Scaling and Performance Observability Metrics | EXTRACT | 1, 3 | Standards in artifact 1 §9; runbook in artifact 3 §6. |
| 24 | Severity / Action Policy (Scaling) | EXTRACT | 4 | Artifact 4 §4.4. |
| 25 | Implementation Notes (Scaling) | EXTRACT | 3 | Artifact 3 §6.3. |
| 26 | Grafana Observability Layer | MIXED | 5 | Strategic role kept; platform standards → artifact 5. |
| 27 | Key Metrics and Suggested Ranges (Grafana) | EXTRACT | 1, 5 | Standards in artifact 1 §10; viz in artifact 5 §4. |
| 28 | Recommended Alerting Policy (Grafana) | EXTRACT | 4, 5 | Policy in artifact 4; Grafana implementation in artifact 5 §5. |
| 29 | Implementation & Visualization Tips (Grafana) | EXTRACT | 5 | Artifact 5 §6. |
| 30 | AI-Driven Observability Layer | MIXED | 6 | Intent + guardrails kept; implementation → artifact 6. |
| 31 | AI-Driven Observability Key Metrics and Ranges | EXTRACT | 6, 1 | Artifact 6 §2; aligned in artifact 1 §11. |
| 32 | AI-Driven Observability Metrics | EXTRACT | 6 | Embedded in artifact 6 §2. |
| 33 | Interpreting the AI-Driven Metrics | EXTRACT | 6 | Artifact 6 §3. |
| 34 | Severity Policy for AI-Detected Events | EXTRACT | 4, 6 | Artifact 4 §4.6; artifact 6 §4. |
| 35 | Implementation Recommendations (AI) | EXTRACT | 6 | Artifact 6 §5. |
| 36 | IaC Role in OpenTelemetry Deployment | MIXED | 7 | Strategic policy kept; patterns/controls → artifact 7. |
| 37 | Key Metrics for IaC Role in OTel Deployments | EXTRACT | 7, 11 | Platform KPIs in artifact 7 §4; roll-up in artifact 11 §5. |
| 38 | Severity Policy (IaC) | EXTRACT | 4 | Artifact 4 §4.7. |
| 39 | Implementation & Visualization Tips (IaC) | EXTRACT | 7 | Artifact 7 §6. |
| 40 | Multi-Cloud Observability Design | MIXED | 2 | Superseded by host-portable Compose model in artifact 2 §6; multi-cloud K8s posture retired. |
...
| 43 | Telemetry retention tiers | EXTRACT | 8 | Artifact 8 §3. |
| 44 | Worked Example: Applying Retention Policy | EXTRACT | 8 | Artifact 8 §4. |
| 45 | Governance Model | EXTRACT | 15 | Artifact 15 §3, §6. |
| 46 | Lifecycle Management and Cost Optimisation | EXTRACT | 9 | Artifact 9 §2–§4. |
| 47 | 11.5 Compliance and Auditability | EXTRACT | 10 | Artifact 10 §2–§5. |
| 48 | Success Criteria for Governance and Data Strategy | EXTRACT | 11 | Artifact 11 §4. |
| 49 | End-to-End Incident Sequence | EXTRACT | 12 | Artifact 12 §2. |
| 50 | Maturity Roadmap | MIXED | 13 | Executive view kept; milestones → artifact 13. |
| 51 | Phase 1: Foundation (Months 1–3) | EXTRACT | 13 | Artifact 13 §2. |
| 52 | Phase 2: Correlation & Alerting (Months 4–6) | EXTRACT | 13 | Artifact 13 §3. |
| 53 | Phase 3: AI-Driven Intelligence (Months 7–12) | EXTRACT | 13 | Artifact 13 §4. |
| 54 | Maturity Assessment Framework | EXTRACT | 14 | Artifact 14 §2–§3. |
| 55 | Final Architecture Summary | KEEP | — | Stays in strategy. |
| 56 | Architecture Governance and Review | MIXED | 15 | Narrative kept; mechanics → artifact 15 §4. |
