...
## 4.4 Domain-Specific Triggers (Reference)

### 4.4.1 Application (Pre-Login & Post-Login)
...
### 4.4.5 Grafana / Cross-Layer Dashboards
...
### 4.4.7 IaC / OpenTelemetry Deployment
