...
A **break-glass** path exists for severity-Critical incident-response dashboard fixes: a designated SRE may apply a hot-fix via grizzly direct to prod with a follow-up PR within 24 hours. The break-glass action is logged and reviewed at the next CoP ([Chapter 18. Observability Operating Model and Adoption Plan -> Section 4.1. Community of Practice](18.%20Observability%20Operating%20Model%20and%20Adoption%20Plan.md#41-community-of-practice)).
...
- [Chapter 7. IaC for Observability Standard](7.%20IaC%20for%20Observability%20Standard.md) — IaC standard the Section 7.1 workflow conforms to.
...
- [Chapter 24. SLO and Error-Budget Framework](24.%20SLO%20and%20Error-Budget%20Framework.md) — burn-rate panels embedded in Section 7.1.4 service dashboards.
