...
Full thresholds in **[1. Enterprise Observability Standards Catalog § 10. Grafana Visualization Layer Standards](1.%20Enterprise%20Observability%20Standards%20Catalog.md#10-grafana-visualization-layer-standards)**. Summary:
...
Severity model is owned by **[4. Alerting and Incident Severity Policy](4.%20Alerting%20and%20Incident%20Severity%20Policy.md)**. Grafana implementation specifics:
...
- Each alert references a runbook URL (linking to **[3. Domain Observability Runbooks Pack](3.%20Domain%20Observability%20Runbooks%20Pack.md)** / **[12. Incident Response Playbook](12.%20Incident%20Response%20Playbook.md)**).
...
- **Anomaly overlays.** Predicted-vs-actual curves and anomaly deviation values rendered alongside live data (see **[6. AIOps Guardrails and Implementation Playbook](6.%20AIOps%20Guardrails%20and%20Implementation%20Playbook.md)**).
...
## 8. Cross-References
- **[1. Enterprise Observability Standards Catalog](1.%20Enterprise%20Observability%20Standards%20Catalog.md)** — metric standards and thresholds.
- **[2. Observability Reference Architecture](2.%20Observability%20Reference%20Architecture.md)** — Grafana's role in the reference architecture.
- **[4. Alerting and Incident Severity Policy](4.%20Alerting%20and%20Incident%20Severity%20Policy.md)** — enterprise severity policy.
- **[6. AIOps Guardrails and Implementation Playbook](6.%20AIOps%20Guardrails%20and%20Implementation%20Playbook.md)** — AI overlays in Grafana.
- **[11. Observability KPI Scorecard](11.%20Observability%20KPI%20Scorecard.md)** — KPI scorecard rendered through Grafana.
