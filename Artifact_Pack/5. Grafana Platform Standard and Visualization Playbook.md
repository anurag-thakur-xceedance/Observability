...
Full thresholds in **[Chapter 1. Enterprise Observability Standards Catalog -> Section 10. Grafana Visualization Layer Standards](1.%20Enterprise%20Observability%20Standards%20Catalog.md#10-grafana-visualization-layer-standards)**. Summary:
...
Severity model is owned by **[Chapter 4. Alerting and Incident Severity Policy](4.%20Alerting%20and%20Incident%20Severity%20Policy.md)**. Grafana implementation specifics:
...
- Each alert references a runbook URL (linking to **[Chapter 3. Domain Observability Runbooks Pack](3.%20Domain%20Observability%20Runbooks%20Pack.md)** / **[Chapter 12. Incident Response Playbook](12.%20Incident%20Response%20Playbook.md)**).
...
- **Anomaly overlays.** Predicted-vs-actual curves and anomaly deviation values rendered alongside live data (see **[Chapter 6. AIOps Guardrails and Implementation Playbook](6.%20AIOps%20Guardrails%20and%20Implementation%20Playbook.md)**).
...
All Grafana dashboards, alert rules, and notification policies are managed **as code**. No production dashboard is hand-edited in the UI; UI changes are exported and committed via PR. This is enforced by **OBS-C-02** in [Chapter 10 §5](10.%20Compliance%20and%20Audit%20Control%20Matrix.md#5-control-matrix-initial).

### 7a.1 Repository Layout
...
A **break-glass** path exists for severity-Critical incident-response dashboard fixes: a designated SRE may apply a hot-fix via grizzly direct to prod with a follow-up PR within 24 hours. The break-glass action is logged and reviewed at the next CoP ([Chapter 18 §4.1](18.%20Observability%20Operating%20Model%20and%20Adoption%20Plan.md#41-community-of-practice)).

### 7a.4 Service Dashboard Template (RED)
...
Service teams provide only `serviceName` and `tier`; the dashboard itself is generated. This is the single largest lever for the **dashboard self-service rate** KPI in [Chapter 18 §7.1](18.%20Observability%20Operating%20Model%20and%20Adoption%20Plan.md#71-adoption-kpis).

### 7a.5 Drift Detection
...
## 8. Cross-References
- **[Chapter 1. Enterprise Observability Standards Catalog](1.%20Enterprise%20Observability%20Standards%20Catalog.md)** — metric standards and thresholds.
- **[Chapter 2. Observability Reference Architecture](2.%20Observability%20Reference%20Architecture.md)** — Grafana's role in the reference architecture.
...
- **[Chapter 6. AIOps Guardrails and Implementation Playbook](6.%20AIOps%20Guardrails%20and%20Implementation%20Playbook.md)** — AI overlays in Grafana.
- **[Chapter 7. IaC for Observability Standard](7.%20IaC%20for%20Observability%20Standard.md)** — IaC standard the §7.1 workflow conforms to.
- **[Chapter 10. Compliance and Audit Control Matrix](10.%20Compliance%20and%20Audit%20Control%20Matrix.md)** — OBS-C-02 audits the dashboards-as-code controls.
- **[Chapter 11. Observability KPI Scorecard](11.%20Observability%20KPI%20Scorecard.md)** — KPI scorecard rendered through Grafana.
- **[Chapter 24. SLO and Error-Budget Framework](24.%20SLO%20and%20Error-Budget%20Framework.md)** — burn-rate panels embedded in §7.1.4 service dashboards.
