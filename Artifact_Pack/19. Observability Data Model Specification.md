...
- Metric names: `<domain>.<entity>.<measure>.<unit>` (see **[17. Application Telemetry Standard § 5. Naming Conventions](17.%20Application%20Telemetry%20Standard.md#5-naming-conventions)**, **[1. Enterprise Observability Standards Catalog § 3. Naming and Labelling Standards](1.%20Enterprise%20Observability%20Standards%20Catalog.md#3-naming-and-labelling-standards)**).
- Labels: bounded cardinality; high-cardinality labels removed/bucketed after retention window (see **[8. Observability Data Governance and Retention Policy § 6. Data Quality and Standards](8.%20Observability%20Data%20Governance%20and%20Retention%20Policy.md#6-data-quality-and-standards)**, **[9. Observability FinOps Standard § 3. Down-Sampling and Aggregation](9.%20Observability%20FinOps%20Standard.md#3-down-sampling-and-aggregation)**).

## 7. PII & Sensitive Data
PII is prohibited in logs and traces wherever possible. Masking, tokenisation, or redaction enforced at source or in the pipeline (see **[8. Observability Data Governance and Retention Policy § 5. Data Classification](8.%20Observability%20Data%20Governance%20and%20Retention%20Policy.md#5-data-classification)**).

## 8. To Be Authored (Follow-Up)
- JSON schema for required log fields per service tier.
- Trace span hierarchy schema for the four named user journeys (see **[17. Application Telemetry Standard § 4. Post-Login Telemetry (Required Fields & Standards)](17.%20Application%20Telemetry%20Standard.md#4-post-login-telemetry-required-fields-standards).2**).
- Entity relationship diagram (ERD).
- Mapping from this model to Prometheus / Loki / Tempo native data formats.

## 9. Cross-References
- **[1. Enterprise Observability Standards Catalog](1.%20Enterprise%20Observability%20Standards%20Catalog.md)** — naming and labelling standards.
- **[2. Observability Reference Architecture](2.%20Observability%20Reference%20Architecture.md)** — pipeline storing this data.
- **[8. Observability Data Governance and Retention Policy](8.%20Observability%20Data%20Governance%20and%20Retention%20Policy.md)** — governance and classification.
- **[17. Application Telemetry Standard](17.%20Application%20Telemetry%20Standard.md)** — application-level field requirements.
