...
## 1. Purpose
Defines **what** application services must emit, **how** fields are named, and **what thresholds** they must adhere to. Operational triage steps live in **[3. Domain Observability Runbooks Pack § 3. Application Observability Runbook (Pre-Login & Post-Login Execution Steps)](3.%20Domain%20Observability%20Runbooks%20Pack.md#3-application-observability-runbook-pre-login-post-login-execution-steps)**.

## 2. Scope
All Xceedance applications (PaaS-hosted, SaaS-hosted, customer-deployed) must emit pre-login and post-login telemetry via OpenTelemetry SDKs and pipelines defined in **[2. Observability Reference Architecture](2.%20Observability%20Reference%20Architecture.md)**.
...
- `timestamp`, `level`, `service.name`, `auth.outcome`, `error.code`, `correlation.id`. **No PII** (see **[8. Observability Data Governance and Retention Policy](8.%20Observability%20Data%20Governance%20and%20Retention%20Policy.md)**).
...
- Masking / tokenisation / redaction enforced at source or in the OpenTelemetry pipeline (see **[8. Observability Data Governance and Retention Policy § 5. Data Classification](8.%20Observability%20Data%20Governance%20and%20Retention%20Policy.md#5-data-classification)**).

## 7. Conformance
- Services must meet this standard before production promotion (see **[8. Observability Data Governance and Retention Policy § 6. Data Quality and Standards](8.%20Observability%20Data%20Governance%20and%20Retention%20Policy.md#6-data-quality-and-standards)**).
- Conformance evidence is part of release readiness.

## 8. Cross-References
- **[1. Enterprise Observability Standards Catalog](1.%20Enterprise%20Observability%20Standards%20Catalog.md)** — enterprise standards umbrella.
- **[2. Observability Reference Architecture](2.%20Observability%20Reference%20Architecture.md)** — pipeline and backend that consume this telemetry.
- **[3. Domain Observability Runbooks Pack § 3. Application Observability Runbook (Pre-Login & Post-Login Execution Steps)](3.%20Domain%20Observability%20Runbooks%20Pack.md#3-application-observability-runbook-pre-login-post-login-execution-steps)** — operational runbook applying this telemetry.
- **[5. Grafana Platform Standard and Visualization Playbook](5.%20Grafana%20Platform%20Standard%20and%20Visualization%20Playbook.md)** — Grafana visualization of these metrics.
- **[8. Observability Data Governance and Retention Policy](8.%20Observability%20Data%20Governance%20and%20Retention%20Policy.md)** — PII / data governance constraints.
- **[19. Observability Data Model Specification](19.%20Observability%20Data%20Model%20Specification.md)** — formal data model for span hierarchy and entities.
