...
## 8.4 Worked Example: Applying Retention Policy
...
## 8.6 Data Quality and Standards
...
## 8.7 Deletion and Retention Enforcement
...
## 8.8 Lifecycle Mechanics (linked to FinOps)
...
### 8.9.2 Operational Activity Calendar
...
| Cardinality drift review ([Chapter 1. Enterprise Observability Standards Catalog -> Section 1.3.4 Cardinality Governance](01-enterprise-observability-standards-catalog.md#134-cardinality-governance)) | Weekly | Platform Ops | Active-series report |
...
**Retention change.** Data Governance proposes change → Platform Ops models cost and capacity impact ([Chapter 22. Capacity and Scale Model](22-capacity-and-scale-model.md)) → governance body approves → Platform Ops applies via IaC ([Chapter 7. IaC for Observability Standard](07-iac-for-observability-standard.md)) → post-change validation per [Chapter 7. IaC for Observability Standard (Docker Compose + PowerShell) -> Section 7.7.1 Change Management](07-iac-for-observability-standard.md#771-change-management).
...
### 8.9.4 Operational Toil Targets
...
- [Chapter 7. IaC for Observability Standard (Docker Compose + PowerShell) -> Section 7.7.1 Change Management](07-iac-for-observability-standard.md#771-change-management) — change workflow used for Section 9.1 retention changes.
