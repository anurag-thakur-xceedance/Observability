...
| Accepted | The binding ARB decision was issued; in effect |
| Rejected | ARB declined the proposal; rationale recorded |
| Superseded | A newer ADR replaces this one; a link to the successor is mandatory |
| Deprecated | The decision is no longer applicable (e.g., technology decommissioned); a new decision does not supersede it |
