...
| Post-incident governance review ([13. Incident Response Playbook (Telemetry to Resolution)](13-incident-response-playbook.md)) | R | R | C | C | C | A | I |
| Approve customer-tenant onboarding ([27. Multi-Tenant and Customer-Site Deployment Model](27-multi-tenant-and-customer-site-deployment-model.md)) | C | R | C | I | C | A | C |
| HA / DR drill execution ([22. Observability Platform HA and DR Design](22-observability-platform-ha-and-dr-design.md)) | I | A,R | I | I | I | I | I |
...
|---|---|---|---|---|---|
| GOV-R-01 | Standards drift: services bypass `1.` standards under delivery pressure | Med | High | Governance Body | PRR gate ([26. Service Onboarding and Instrumentation Kits](26-service-onboarding-and-instrumentation-kits.md)); compliance scan ([11. Compliance and Audit Control Matrix](11-compliance-and-audit-control-matrix.md) OBS-C-09) | Conformance score < 90% (KPI in [12. Observability KPI Scorecard](12-observability-kpi-scorecard.md)) |
...
| GOV-R-06 | AIOps model drift / silent failure | Med | High | AIOps Lead | Model lifecycle controls ([7. AIOps Guardrails and Implementation Playbook](07-aiops-guardrails-and-implementation-playbook.md)); shadow-mode validation | Precision drop > 10% week-on-week |
...
| GOV-R-08 | Telemetry cost overruns above approved envelope | Med | Med | FinOps | Unit-economics dashboards ([10. Observability FinOps Standard](10-observability-finops-standard.md)); tier-based sampling | Cost per service > 110% of plan |
...
|---|---|---|---|
| **SOC 2 Type II** | Security, Availability, Confidentiality | Primary | Full control mapping; annual audit. See [11. Compliance and Audit Control Matrix](11-compliance-and-audit-control-matrix.md) Section 7. |
| **ISO/IEC 27001:2022** | Information security management | Primary | Annex A controls A.5–A.18 mapped to OBS-C-* controls. |
| **GDPR** (EU) | Personal data protection | Primary | Articles 5, 17, 25, 32, 33 mapped; PII redaction enforced ([24. Observability Platform Security Architecture](24-observability-platform-security-architecture.md)). |
...
- **Post-Incident:** governance review when major incidents trigger systemic changes (links to [13. Incident Response Playbook (Telemetry to Resolution)](13-incident-response-playbook.md) / [17. Observability ADR Decision Register](17-observability-adr-decision-register.md)).
...
Coordinates with [11. Compliance and Audit Control Matrix](11-compliance-and-audit-control-matrix.md) for audit evidence and [12. Observability KPI Scorecard](12-observability-kpi-scorecard.md) for governance KPIs (retention adherence, audit pass rate).

## 16.8 Cross-References
- [9. Observability Data Governance and Retention Policy](09-observability-data-governance-and-retention-policy.md) — data governance policy enforced under this charter.
- [11. Compliance and Audit Control Matrix](11-compliance-and-audit-control-matrix.md) — compliance evidence; framework mapping (Section 5.3) consumed there.
- [12. Observability KPI Scorecard](12-observability-kpi-scorecard.md) — governance success KPIs.
- [17. Observability ADR Decision Register](17-observability-adr-decision-register.md) — ADRs ratified by this body.
...
- [26. Service Onboarding and Instrumentation Kits](26-service-onboarding-and-instrumentation-kits.md) — PRR gate enforcing standards approved by Section 4.
