...
| R-ID | Owner | Category | Likelihood (L) | Impact (I) | Score | Mitigation Summary | Residual L | Residual I | Residual Score | Risk | Source |
|---|---|---|---|---|---|---|---|---|---|---|---|
| R-01 | Platform Lead | FinOps / Capacity | 4 | 4 | 16 | Enforce per-service cardinality budgets and capacity thresholds; see [Chapter 2. Enterprise Observability Standards Catalogue -> Section 2.3.4 Cardinality Governance](02-enterprise-observability-standards-catalog.md#234-cardinality-governance), [Chapter 23. Capacity and Scale Model](23-capacity-and-scale-model.md), and [Chapter 10. Observability FinOps Standard](10-observability-finops-standard.md). | 2 | 3 | 6 | Cause: metrics cardinality grows beyond forecast. Effect: capacity model is exceeded, causing unplanned cost or platform instability. | Chapter 1, Chapter 9, Chapter 22 |
| R-02 | AIOps Lead | AI / Safety | 3 | 4 | 12 | Shadow-mode rollout for `rca-hypothesis-v1`; human-in-the-loop on all change-adjacent agents; guardrails in [Chapter 7. AIOps Guardrails and Implementation Playbook](07-aiops-guardrails-and-implementation-playbook.md). | 2 | 3 | 6 | AIOps agent produces a confidently-wrong recommendation that is acted on and causes a customer-visible incident. | Chapter 6 |
| R-03 | Data Protection Officer | Privacy / Compliance | 3 | 5 | 15 | Classify and redact sensitive fields before storage; enforce retention and erasure workflows; see [Chapter 18. Application Telemetry Standard -> Section 18.6 PII & Data Classification](18-application-telemetry-standard.md#186-pii-data-classification), [Chapter 9. Observability Data Governance and Retention Policy](09-observability-data-governance-and-retention-policy.md), and [Chapter 29. Observability Long-Term Archival Policy -> Section 29.10 Right to Erasure (GDPR Art. 17)](29-observability-long-term-archival-policy.md#2910-right-to-erasure-gdpr-art-17). | 2 | 4 | 8 | Cause: restricted data enters telemetry. Effect: data is retained beyond lawful basis, creating privacy or regulatory exposure. | Chapter 8, Chapter 17, Chapter 28 |
| R-04 | Compliance Officer | Compliance / Audit | 3 | 4 | 12 | WORM storage with object-lock Compliance mode and signed sidecar manifests per [Chapter 29. Observability Long-Term Archival Policy -> Section 29.5.3 Integrity & Tamper Evidence](29-observability-long-term-archival-policy.md#2953-integrity-tamper-evidence). Archival format specification (Parquet/Iceberg/Delta) and rehydration SLO are listed as a known gap in [Handover Report](handover-report.md). | 2 | 3 | 6 | Long-term archive is not tamper-evident in a way that satisfies regulator or auditor evidence requirements. | Chapter 28 |
| R-05 | SRE Lead | Reliability / DR | 3 | 4 | 12 | Run scheduled DR drills and store evidence; see [Chapter 22. Observability Platform HA and DR Design](22-observability-platform-ha-and-dr-design.md), [Chapter 13. Incident Response Playbook (Telemetry to Resolution)](13-incident-response-playbook.md), and [Chapter 11. Compliance and Audit Control Matrix -> Section 11.7 Audit-Evidence Catalogue](11-compliance-and-audit-control-matrix.md#117-audit-evidence-catalogue). | 2 | 3 | 6 | Cause: DR runbooks are documented but not exercised. Effect: a real DR event exceeds RTO/RPO. | Chapter 12, Chapter 21 |
| R-06 | Platform Lead | Vendor / Architecture | 3 | 3 | 9 | OpenTelemetry-native instrumentation per [Chapter 18. Application Telemetry Standard](18-application-telemetry-standard.md) and [Chapter 20. Observability Data Model Specification](20-observability-data-model-specification.md); ADRs that record vendor selection and the exit option per [Chapter 17. Observability ADR Decision Register](17-observability-adr-decision-register.md). | 2 | 3 | 6 | Single-vendor lock-in on the telemetry backend (metrics, logs, or traces) blocks a future repricing or migration. | Chapter 16, Chapter 17, Chapter 19 |
| R-07 | FinOps Lead | FinOps | 4 | 3 | 12 | Unit-cost guardrails and the cost model in [Chapter 10. Observability FinOps Standard -> Section 10.6.15 Twelve-Month Worked Cost Model](10-observability-finops-standard.md#10615-twelve-month-worked-cost-model); quarterly tier-rebalancing review per [Chapter 29. Observability Long-Term Archival Policy -> Section 29.12 Cost Model](29-observability-long-term-archival-policy.md#2912-cost-model). | 2 | 3 | 6 | Observability cost grows faster than the business it supports and forces sampling/retention cuts mid-year. | Chapter 9, Chapter 28 |
| R-08 | Platform Lead | People / Capability | 4 | 3 | 12 | Skills matrix and training plan in [Chapter 19. Observability Operating Model and Adoption Plan](19-observability-operating-model-and-adoption-plan.md); pairing rules for AIOps work in [Chapter 7. AIOps Guardrails and Implementation Playbook](07-aiops-guardrails-and-implementation-playbook.md). | 3 | 3 | 9 | Skills gap on the platform team (OpenTelemetry, query languages, AIOps prompt engineering) slows delivery or causes outages. | Chapter 6, Chapter 18 |
| R-09 | ARB Chair | Adoption / Governance | 4 | 3 | 12 | Onboarding checklist and named-journeys coverage in [Chapter 26. Service Onboarding and Instrumentation Kits](26-service-onboarding-and-instrumentation-kits.md); ARB conformance review per [Chapter 16. Observability Governance Charter and ARB Pack](16-observability-governance-charter-and-arb-pack.md). | 3 | 2 | 6 | Adoption of the telemetry standard by service teams stalls, so observability coverage remains uneven and SLOs are unreliable. | Chapter 15, Chapter 25 |
| R-10 | Compliance Officer | Regulatory | 3 | 4 | 12 | Sector-regulation mapping in [Chapter 11. Compliance and Audit Control Matrix -> Section 11.6 Framework Mapping](11-compliance-and-audit-control-matrix.md#116-framework-mapping); ARB-tracked horizon scan reviewed quarterly. | 2 | 3 | 6 | Regulatory change (DORA, NAIC Model #674, APRA CPS 234, or equivalent) introduces obligations the current control set does not satisfy. | Chapter 10, Chapter 15 |
| R-11 | Platform Lead | Multi-tenant / Compliance | 3 | 3 | 9 | Deployment-topology constraints in [Chapter 3. Observability Reference Architecture](03-observability-reference-architecture.md); customer-site addendum process in [Chapter 27. Multi-Tenant and Customer-Site Deployment Model](27-multi-tenant-and-customer-site-deployment-model.md). | 2 | 3 | 6 | Customer-site / on-prem deployments diverge from the SaaS platform standard, so a single evidence story cannot be told to auditors. | Chapter 2, Chapter 26 |
| R-12 | Security Lead | Security | 2 | 5 | 10 | Apply threat-model controls, immutable audit logging, and tamper-evident evidence storage; see [Chapter 24. Observability Platform Security Architecture](24-observability-platform-security-architecture.md), [Chapter 11. Compliance and Audit Control Matrix](11-compliance-and-audit-control-matrix.md), and [Chapter 29. Observability Long-Term Archival Policy -> Section 29.5.3 Integrity & Tamper Evidence](29-observability-long-term-archival-policy.md#2953-integrity-tamper-evidence). | 1 | 4 | 4 | Cause: credentials, supply chain, or collector configuration are compromised. Effect: observability-path tampering goes undetected. | Chapter 10, Chapter 23, Chapter 28 |
| R-13 | Platform Lead | Data Quality | 4 | 3 | 12 | Canonical schemas, ERD, and OTel crosswalk in [Chapter 20. Observability Data Model Specification -> Section 20.8 Canonical JSON Schemas, ERD, and OTel Crosswalk](20-observability-data-model-specification.md#208-canonical-json-schemas-erd-and-otel-crosswalk); conformance gate in [Chapter 26. Service Onboarding and Instrumentation Kits](26-service-onboarding-and-instrumentation-kits.md). | 2 | 3 | 6 | Schema drift between application emitters, the OpenTelemetry Collector, and the storage backends silently breaks dashboards, alerts, and AIOps inputs. | Chapter 25, Chapter 19 |
| R-14 | Programme Sponsor | Strategic | 3 | 4 | 12 | Outcome metrics and value tree in [Chapter 14. Observability Roadmap Delivery Plan](14-observability-roadmap-delivery-plan.md); quarterly value report to ARB; FinOps view in [Chapter 10. Observability FinOps Standard](10-observability-finops-standard.md). | 2 | 3 | 6 | Programme cannot demonstrate ROI within the first 12 months and loses executive sponsorship or budget. | Chapter 13, Chapter 9, Chapter 15 |
| R-15 | ARB Chair | Governance | 4 | 3 | 12 | Versioned chapter front matter with `next_review` dates; ARB-owned review cycle per [Chapter 16. Observability Governance Charter and ARB Pack](16-observability-governance-charter-and-arb-pack.md); traceability matrix kept current per [Traceability Matrix](traceability-matrix.md). | 2 | 2 | 4 | Documentation rot: standards drift from the running platform, so the artefact pack becomes a reference no one trusts. | Chapter 15 |
